...
public class ValidationSubscription
    ...
    final public Validator<IMMUTABLE_CHANGES> validator;

    public ValidationSubscription(final Validator<IMMUTABLE_CHANGES> _validator,
                                  final ValidationBus
                                          <STATE, STATE_WRAPPER, IMMUTABLE_CHANGES, IMMUTABLE_STATE> _validationBus)
            throws Exception {
