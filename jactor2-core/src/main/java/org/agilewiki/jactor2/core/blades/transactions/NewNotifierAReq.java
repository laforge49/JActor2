...
abstract public class NewNotifierAReq<STATE, STATE_WRAPPER extends AutoCloseable, IMMUTABLE_CHANGES extends ImmutableChanges, IMMUTABLE_STATE>
        extends AsyncRequest<ChangeSubscription<IMMUTABLE_CHANGES>> {
    private final AsyncRequest<ChangeSubscription<IMMUTABLE_CHANGES>> disReq = this;
    ...
    abstract protected String notifyChange(IMMUTABLE_CHANGES _immutableChanges,
            AsyncResponseProcessor<Void> rp) throws Exception;

    @Override
    protected void processAsyncRequest() throws Exception {
        final ChangeNotificationSubscriber<IMMUTABLE_CHANGES> noteTran = new ChangeNotificationSubscriber<IMMUTABLE_CHANGES>() {
            @Override
        ...
        send(transactionProcessor.addChangeNotificationSubscriberAReq(noteTran),
                this);
    }
}
