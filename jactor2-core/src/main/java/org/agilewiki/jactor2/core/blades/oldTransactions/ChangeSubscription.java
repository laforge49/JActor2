...
public class ChangeSubscription<IMMUTABLE_CHANGES> extends
        Subscription<IMMUTABLE_CHANGES, Void> {
    private final ChangeNotificationSubscriber<IMMUTABLE_CHANGES> subscriber;

    public ChangeSubscription(
            final ChangeNotificationSubscriber<IMMUTABLE_CHANGES> _subscriber,
            final RequestBus<IMMUTABLE_CHANGES, Void> _requestBus)
            throws Exception {
