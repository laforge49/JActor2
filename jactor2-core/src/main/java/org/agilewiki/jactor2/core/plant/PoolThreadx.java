 ...
 * The RequestImplBase.call method should not be invoked from a PoolThreadx.
 */
public class PoolThreadx extends Thread {

    private volatile UnboundReactorImpl currentReactor;

    public PoolThreadx(final Runnable _runnable) {
        super(_runnable);
    }
