...
abstract public class TransactionAReq<STATE, STATE_WRAPPER extends AutoCloseable, IMMUTABLE_CHANGES, IMMUTABLE_STATE>
        extends AsyncRequest<Void> {
    private AsyncRequest<Void> disReq = this;
    ...
    abstract protected void evalTransaction(STATE_WRAPPER _stateWrapper, AsyncResponseProcessor<Void> rp)
            throws Exception;

    @Override
    protected void processAsyncRequest() throws Exception {
        Transaction<STATE_WRAPPER> putTran = new Transaction<STATE_WRAPPER>() {
            @Override
            public AsyncRequest<Void> updateAReq(final STATE_WRAPPER _stateWrapper) {
