...
public class KarafWithBundleTest implements BundleListener, ServiceListener {
    ...
    public Option[] config() {
        return new Option[]{karafDistributionConfiguration().frameworkUrl(
                ...
                mavenBundle("org.agilewiki.jactor2", "jactor2-core", "0.3.0"),
                mavenBundle("org.agilewiki.jactor2", "jactor2-util", "0.3.0"),
                mavenBundle("org.agilewiki.jactor2", "jactor2-osgi", "0.3.0"),
                mavenBundle("org.agilewiki.jactor2", "jactor2-test-iface", "0.3.0"),
                mavenBundle("org.agilewiki.jactor2", "jactor2-kdriver", "0.3.0")
        };
    }
