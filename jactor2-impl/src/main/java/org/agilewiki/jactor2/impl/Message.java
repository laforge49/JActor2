...
/**
 * <p>
 * Message encapsulates the user/application BoundRequest which are queued in the Actor's mailbox. The lightweight
 ...
 * The initial BoundRequest is passed to the PActor1 which might further pass the ResponseProcessor to PActor2
